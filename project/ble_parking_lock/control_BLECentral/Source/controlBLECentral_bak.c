 ...
 * EXTERNAL VARIABLES
 */
extern uint8 w5500_socket_state;
extern uint8 w5500_recv_state; 
extern uint8 w5500_send_state;
...
// RSSI polling state
static uint8 simpleBLERssi =TRUE; //FALSE;
...
static void controlBLECenrol_HandleScanCarExist();

extern void start_to_scan_car();
/*********************************************************************
 * PROFILE CALLBACKS
 */
...
/*********************************************************************
 * @fn      controlBLECentral_ProcessOSALMsg
 *
...
/*********************************************************************
 * @fn      controlBLECentral_HandleKeys
 *
...
/*********************************************************************
 * @fn      controlBLECentralPasscodeCB
 *
...
/*********************************************************************
 * @fn      controlBLECentralStartDiscovery
 *
