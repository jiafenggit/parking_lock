...
#define START_GET_BAT_INFO_EVT                        0x0008
#define START_SCAN_CAR_EXSIT_EVT                      0x0010
 ...
 */
extern void lock_in_BLECentral_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 lock_in_BLECentral_ProcessEvent( uint8 task_id, uint16 events );
