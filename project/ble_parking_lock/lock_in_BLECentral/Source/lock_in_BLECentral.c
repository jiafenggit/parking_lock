...
#define  CAR_SIG_NO_EXSIT_TRIGGER_VALUE         (10000/DEFAULT_SCAN_DURATION/2)   //10´ÎÃ»ÓÐ¼ì²âµ½ÐÅºÅ¾ÍÁ¢Æðµµ¸Ë
#define  CAR_SIG_NO_EXSIT_BLOCK_TRIGGER_VALUE   (30*60)//°ë¸öÐ¡Ê±ºóÔÙÐ£ÑéÆð¸Í
