...
#define DEFAULT_DESIRED_CONN_TIMEOUT          200 //1000
...
uint8 addr_update_flag=FALSE;//ÊÇ·ñÐèÒªÑÓ³¤¹ã²¥Ê±¼ä
uint8 cur_conn_target=CUR_CONNET_TARGET_CONTROL;//µ±Ç°¹ã²¥»òÕßÁ¬½Ó¶ÔÏó
...
static void simpleBLEPeripheral_Handlebatt(uint8 batt)
{
  ...
  SimpleProfile_SetParameter(PARAM_BLE_CAR_IN_CHAR,sizeof(ble_device_t),&car_in );
  app_write_string("\r\n¸üÐÂcar in batt Íê³É,µ±Ç°car in:");
