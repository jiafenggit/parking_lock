 ...
 **************************************************************************************************/
   ...
   /*scan car event*/
#if HAL_SCAN_CAR > 0
#define HAL_SCAN_CAR_LATENCY_EVENT          0x4000
#endif  
#if HAL_MOTOR_CHECK > 0
   /*motor check event*/
#define HAL_MOTOR_VERIFY_EVENT                0x0800
#define HAL_MOTOR_CHECK_SPEED_EVENT           0x0400
#define HAL_MOTOR_CHECK_BLOCK_EVENT           0x0200
#endif

 /* check batt event*/
#if HAL_BATT_CHECK  > 0
#define HAL_BATT_CHECK_EVENT                0x0100
#endif
